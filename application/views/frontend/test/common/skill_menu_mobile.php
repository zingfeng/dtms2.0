<div class="fillter-mobile">
	...
	<a class="<?php if($type == 'listening') echo 'active'; ?>"  href="javascript:;" <?php if( (! is_array($arr_list_test_type)) || (! in_array('Listening', $arr_list_test_type))) echo ' style ="display:none" ';  ?>>
	...
	<a class="<?php if($type == 'reading') echo 'active'; ?>"  href="javascript:;" <?php if( (! is_array($arr_list_test_type)) || (! in_array('Reading', $arr_list_test_type)))  echo ' style ="display:none" ';  ?> >
	...
	<a class="<?php if($type == 'writing') echo 'active'; ?>"  href="javascript:;" <?php if( (! is_array($arr_list_test_type)) || (! in_array('Writing', $arr_list_test_type)))  echo ' style ="display:none" ';  ?> >
	...
	<a class="<?php if($type == 'speaking') echo 'active'; ?>"  href="javascript:;" <?php if( (! is_array($arr_list_test_type)) || (! in_array('Speaking', $arr_list_test_type)))  echo ' style ="display:none" ';  ?> >
