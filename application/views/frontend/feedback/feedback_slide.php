...
<head>
    ...
    <title>Phiếu khảo sát chất lượng giảng dạy bằng Slide</title>
    ...
    <div class="row">
        ...
        <div class="col-sm-12 col-md-8 col-lg-6 col-xl-4"  style="/*max-width: 100%; width: 750px; margin: auto; */    background-color: white; padding: 0; " >
            <div style="background-color: transparent; padding: 10px; ">
                <h2 class="title_top">KHẢO SÁT CHẤT LƯỢNG GIẢNG DẠY BẰNG SLIDE</h2>
                <p class="description">
...
?>
            ...
            <h3 class="title_group_quest">Đánh giá phương pháp</h3><?php

            creat_feedback_list_question_radio_MORE_LEVELS($list_quest_radio_LEVELS);

            ?>

            <h3 class="title_group_quest">Đánh giá theo thang điểm</h3><?php
