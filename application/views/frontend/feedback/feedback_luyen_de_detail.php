<h2 class="my_title">Danh sách học viên đăng ký lớp luyện đề
        ...
        <div class="col col-sm-12">
            <table id="dtFeedbackList2" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%">
                ...
                <tr>
                    ...
                    <th class="th-sm" title="Tên học viên">Tên</th>
                    <th class="th-sm">SĐT</th>
                    <th class="th-sm">Email</th>
                    <th class="th-sm">Level</th>
                    <th class="th-sm">Ca học</th>
                ...
                if (isset($rows) && (is_array($rows))) {
                    foreach ($rows as $row) { ?>
                        <tr>
                            ...
                            <td><?php
                                if (isset($level_text[$row['level']])){
                                    echo $level_text[$row['level']];
                                }else{
                                    echo $row['level'];
                                }
                                ?>
                            ...
                            <td><?php
                                if (isset($shift_text[$row['shift']])){
                                    echo $shift_text[$row['shift']];
                                }else{
                                    echo $row['shift'];
                                }
                                ?></td>
