        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col col-sm-12 col-md-8">
                        <div class="form-group">
                            <input type="text" class="form-control" id="link_feedback_slide">
                        </div>
                    </div>
                    <div class="col col-sm-12 col-md-2">
                        <button class="btn btn-warning" id="btn_copy" onclick="ClickOpenLinkFeedback()" >Open</button>
                    </div>
                    <div class="col col-sm-12 col-md-2">
                        <button class="btn btn-primary" id="btn_copy" onclick="ClickCopyFeedback()">Copy</button>
                    </div>
    ...
    <div class="row" id="insert_class" style="padding: 15px">
        ...
        <div class="list_in_table container-fluid" id="list_class">
            <table id="dtClassList" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%">
                <thead>
                <tr>
                    <th class="th-sm" rowspan="2">ID
                    </th>
                    <th class="th-sm" rowspan="2">Type
                    </th>
                    <th class="th-sm" rowspan="2">Mã lớp
                    </th>
                    <th class="th-sm" rowspan="2">Giáo viên
                    </th>
                    <th class="th-sm" rowspan="2">Ngày khai giảng
                    </th>

                    <th class="th-sm" rowspan="2" style="max-width: 300px;">Cơ sở
                    </th>

                    <th class="th-sm" colspan="2">Feedback Form
                    </th>
                    <th class="th-sm" colspan="2">Feedback Phone
                    </th>
                    <th class="th-sm" colspan="2">Feedback Slide
                    </th>
...
<!--                        <td>--><?php //echo $mono_class_info['more_info']; ?><!--</td>-->
                        <td><?php echo $mono_class_info['number_feedback_form']; ?></td>
                        <td><?php echo $mono_class_info['point']; ?></td>
                        <td><?php echo $mono_class_info['number_feedback_phone']; ?></td>
                        <td><?php echo $mono_class_info['point_phone']; ?></td>

                        <td><?php echo $mono_class_info['number_feedback_slide']; ?></td>
                        <td><?php echo $mono_class_info['point_slide']; ?></td>
                        <td style="font-size: x-large; min-width: 250px;">
                            <i info='<?php echo json_encode($mono_class_info); ?>'  class="fa fa-link" aria-hidden="true" title="Link Feedback Form" onclick="load_get_link_class(event)"></i>
