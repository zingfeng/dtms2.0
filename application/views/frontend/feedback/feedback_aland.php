...
<head>
    <base href="/">
    <title>Phiếu khảo sát Aland IELTS</title>
    <link rel="shortcut icon" type="image/x-icon" href="https://dtms.aland.edu.vn/theme/frontend/default/images/favicon.ico">
    ...
    <div class="row">
        ...
        <div class="col-sm-12 col-md-8 col-lg-6 col-xl-4"  style="/*max-width: 100%; width: 750px; margin: auto; */    background-color: white; padding: 0; " >
            <div style="background-color: transparent; padding: 10px; ">
                <h2 class="title_top">KHẢO SÁT LỚP HỌC ALAND</h2>
                <p class="description">
                    Với mong muốn không ngừng nâng cao chất lượng dịch vụ và đào tạo,
                    Aland mong bạn vui lòng dành chút thời gian hoàn thành Phiếu khảo sát chất lượng dưới đây</p>
            </div>
