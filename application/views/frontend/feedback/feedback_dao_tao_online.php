...
<head>
    ...
    <title>Phiếu khảo sát Ms Hoa TOEIC</title>
    ...
    <div class="row">
        ...
        <div class="col-sm-12 col-md-8 col-lg-6 col-xl-4"  style="/*max-width: 100%; width: 750px; margin: auto; */    background-color: white; padding: 0; " >
            <div style="background-color: transparent; padding: 10px; ">
                <h2 class="title_top">KHẢO SÁT LỚP HỌC IMAP VIỆT NAM</h2>
                <p class="description">
                    Với mong muốn không ngừng nâng cao chất lượng dịch vụ và đào tạo, Hệ thống Giáo dục và Đào tạo IMAP Việt Nam mong bạn vui lòng dành chút thời gian hoàn thành Phiếu khảo sát chất lượng dưới đây, sự đóng góp ý kiến của bạn sẽ giúp IMAP Việt Nam ngày một hoàn thiện và nỗ lực hết sức để mang đến cho bạn dịch vụ tốt nhất</p>
            </div>
            ...
            <?php  creat_feedback_list_question_ruler($list_quest_ruler,500); ?>
