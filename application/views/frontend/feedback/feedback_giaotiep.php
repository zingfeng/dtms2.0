<html>
<head>
    <title>Phiếu khảo sát Ms Hoa Giao Tiếp</title>
    <link rel="shortcut icon" type="image/x-icon" href="https://mshoagiaotiep.com/theme/frontend/default/images/favicon.ico">
    ...
    <div class="row">
        ...
        <div class="col-sm-12 col-md-8 col-lg-6 col-xl-4"
            ...
            <div style="background-color: transparent; padding: 10px; ">
                <h2 class="title_top">KHẢO SÁT LỚP HỌC <br>MS HOA GIAO TIẾP</h2>
                <p class="description">Với mong muốn không ngừng nâng cao chất lượng dịch vụ và đào tạo, Trung tâm Ms
                    Hoa TOEIC mong bạn vui lòng dành chút thời gian hoàn thành Phiếu khảo sát chất lượng dưới đây, sự
                    đóng góp ý kiến của bạn sẽ giúp Ms Hoa TOEIC ngày một hoàn thiện và nỗ lực hết sức để mang đến cho
                    bạn dịch vụ tốt nhất</p>
            </div>
