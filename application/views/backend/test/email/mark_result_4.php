...
<html>
    <head>
        ...
        <title>Chấm điểm bài test speaking</title>
            ...
            <tr>
                ...
                <tr>
                    <td style="padding: 10px 20px">
                        ...
                        <p>Aland English xin thông báo kết quả làm bài test speaking của <?php echo $user['fullname'] ?> như sau::</p>  
                    </td>
                </tr>
                <?php $i = 1; foreach($answer as $key => $item) { ?>
                <tr>
                    <td style="padding: 10px 20px">
                        <p style="text-transform: uppercase; color: red">Part <?php echo $i?></p>
                        <b>Xem lại bài làm tại đây:</b>
                        <?php if($item) { ?>
                            <?php foreach($item as $row) { ?>
                                <p>
                                    <?php echo getFileLink($row, 'sound_user'); ?>
                                </p>
                            <?php } ?>
                        <?php } ?>
                    </td>
                ...
                <tr>
                    <td style="padding: 10px 20px">
                        ...
                        <b>Điểm trung bình speaking:</b> <b style="color: red"><?php echo $total_score?> điểm</span></b>
                    </td>
                </tr>
                <tr>
                    <td style="padding:10px 20px">
