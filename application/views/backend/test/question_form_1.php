...
<form class="form-horizontal form-label-left ajax-submit-form" action="" method="POST">
    <div class="form-group">
        ...
        <button class="btn btn-success ajax-submit-button"
                type="submit"><?php echo $this->lang->line("common_save"); ?></button>
        <?php if ($row['question_id']) { ?>
            <input type="hidden" name="token"
                   value="<?php echo $this->security->generate_token_post($row['question_id']) ?>"/>
        <?php } ?>
    </div>
    <div class="row">
                        ...
                        <div class="x_content row">
                                        ...
                                        <?php if (!$row) { ?>
                                            <select class="form-control" required name="type">
                                                ...
                                                <?php foreach ($test_type as $key => $typeName) { ?>
                                                    <option <?php if ($row['type'] == $key) echo 'selected'; ?>
                                                            value="<?php echo $key; ?>"><?php echo $typeName; ?></option>
                                                <?php } ?>
                                            </select>
                                        <?php } else {
                                            ...
                                            <input required type="text" disabled
                                                   value="<?php echo $test_type[$row['type']]; ?>"
                                                   placeholder="Tên câu hỏi" class="form-control">
                                        <?php } ?>
                                    </div>
                                </div>
                            <?php } else { ?>
                            ...
                            <div class="form-group validation_title">
                                ...
                                <div class="col-sm-10 col-xs-12 validation_form">
                                    <input required type="text" name="title" value="<?php echo $row['title']; ?>"
                                           placeholder="Tên câu hỏi" class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10 col-xs-12">
                                    <div class="checkbox">
                                        <label><input type="checkbox"
                                                      value="1" <?php echo ($row['publish'] == 1 || !isset($row['publish'])) ? 'checked' : ''; ?>
                                                      name="publish"></label>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group validation_title">
                                ...
                                <div class="col-sm-10 col-xs-12 validation_form">
                                    <input required type="text" name="ordering" value="<?php echo $row['ordering']; ?>"
                                           placeholder="Thứ tự" class="form-control">
                                </div>
                            </div>
                            ...
                            <?php if ($parent_id == 0) { ?>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10 col-xs-12 filemanager_media">
                                        <img class="image_org" data-name="question_sound" data-type="sound"
                                             data-selected="<?php echo $row['sound']; ?>"
                                             src="<?php echo $this->config->item("img") . 'default_image.jpg'; ?>">
                                        <div class="sound_preview">
                                            <?php if ($row['sound']) { ?>
                                                <audio controls>
                                                    <source src="<?php echo getFileLink($row['sound']); ?>"
                                                            type="audio/mpeg">
                                        ...
                                        <input type="hidden" class="sound_input" name="sound"
                                               value="<?php echo $row['sound']; ?>"/>
                                    </div>
                                </div>
                                <div class="form-group validation_title">
                                    <label class="control-label col-sm-2 col-xs-12">Thời gian làm bài</label>
                                    <div class="col-sm-10 col-xs-12 validation_form">
                                        <input required type="text" name="test_time"
                                               value="<?php echo $row['test_time']; ?>" placeholder="Thời gian làm bài"
                                               class="form-control">
                                    </div>
                                </div>
                            <?php } else { ?>
                                <div class="form-group ckeditor_detail">
                                    ...
                                    <div class="col-sm-10 col-xs-12">
                                        <textarea name="detail" class="form-control" placeholder="Chi tiết"
                            ...
                            <div class="form-group ckeditor_detail">
                                <label class="control-label col-sm-2 col-xs-12">Tapescript</label>
                                <div class="col-sm-10 col-xs-12">
                                    <textarea name="tapescript" class="form-control" placeholder="Chi tiết"
                                              rows="5"><?php echo $row['tapescript']; ?></textarea>
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="control-label col-sm-2 col-xs-12">Thời gian bắt đầu hội thoại</label>
                                <div class="col-sm-10 col-xs-12 validation_form">
                                    <input type="text" name="audio_start_time" value="<?php echo $row['audio_start_time']; ?>"
                                           placeholder="Đơn vị: giây" class="form-control">
                                </div>
                            </div>
