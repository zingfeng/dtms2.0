...
<div class="row">
    <div class="col-sm-12 col-xs-12">
        <ul class="nav nav-tabs">
            ...
            <li role="presentation"><a id="detail-tab" href="#answer_<?php echo $key?>" role="tab" data-toggle="tab" aria-controls="test_detail" aria-expanded="false"><?php echo $item['title']?></a></li>
        	<?php } ?>
        </ul>
    </div>
</div>
