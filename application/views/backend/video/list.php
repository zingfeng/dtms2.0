...
?>
<!-- page content -->
<div id="video_lists" class="page-lists">
		...
		<div class="x_panel">
			...
			<div class="x_content" style="display: none;">
				<div class="col-tn-12 col-xs-6 col-sm-3 form-group">
					...
					<input type="text" name="title" value="<?php echo $filter['keyword']; ?>" placeholder="Tên Video" class="form-control">
	            </div>
	            <div class="col-tn-12 col-xs-6 col-sm-3 form-group">
					<label class="control-label">Xuất bản</label>
	            ...
	            <div class="col-tn-12 col-xs-6 col-sm-3 form-group">
					<label class="control-label">Nhóm video</label>
						...
						<table class="table table-striped jambo_table table-bordered">
							...
							<tbody id="checkbox_list">
								...
								<tr>
									<?php if ($pDelete) { ?>
									<td class="a-center ">
										<input type="checkbox" value="<?php echo $row['video_id']; ?>" class="inputSelect" name="cid[]">
									</td>
									<?php } ?>
									...
									<td class="action last" align="center">
										...
										<a data-toggle="tooltip" data-placement="top" title="<?php echo $this->lang->line("common_edit"); ?>" href="<?php echo SITE_URL; ?>/video/edit/<?php echo $row['video_id']; ?>">
											<i class="fa fa-edit"></i>
										</a>
										<?php } ?>
										<?php if ($pDelete) { ?>
										<a class="quick-delete" data-toggle="tooltip" data-placement="top" title="<?php echo $this->lang->line("common_delete"); ?>" data-id="<?php echo $row['video_id']; ?>" href="javascript:void(0)" rel="nofollow">
	...
	<div class="page-title scroll_action">
		<div class="title_left">
			...
			<a class="btn btn-primary" href="<?php echo SITE_URL; ?>/video/add">Thêm Video</a>
			<?php } ?>
			<?php if ($pDelete) { ?>
