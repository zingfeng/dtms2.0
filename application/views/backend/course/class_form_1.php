	...
	<div class="tab-content">
			...
			<div class="x_panel">
				...
				<div class="x_content row">
	                ...
	                <div class="form-group validation_document">
						<label class="control-label col-sm-2 col-xs-12">Tài liệu</label>
						<div class="col-sm-10 col-xs-12 validation_form">
							<input type="text" name="document" value="<?php echo $row['document']; ?>" placeholder="Tài liệu" class="form-control">
						</div>
	                </div>
	                <div class="form-group">
		...
		<div id="step3" class="col-sm-12 col-xs-12 tab-pane" role="tabpanel">
			<div class="x_panel">
                ...
                <div class="form-group">
					<label class="control-label col-sm-2 col-xs-12">Thời lượng video</label>
					<div class="col-sm-10 col-xs-12 validation_form">
						<input type="text" name="duration" value="<?php echo $row['duration']; ?>" placeholder="mm:ss" class="form-control">
					</div>
                </div>
			</div>
		</div>
	...
	<div class="col-sm-6 col-xs-12">
		<div class="x_panel">
			...
			<div class="x_content row">
				...
				<div class="form-group">
					<label class="control-label col-md-3 col-sm-3 col-xs-12"><?php echo $this->lang->line("course_class_date_start"); ?></label>
					<div class="col-md-9 col-sm-9 col-xs-12">
				...
				<div class="form-group">
					<label class="control-label col-md-3 col-sm-3 col-xs-12"><?php echo $this->lang->line("course_class_date_end"); ?></label>
					<div class="col-md-9 col-sm-9 col-xs-12">
