...
$arrPosition = $configBlock['course_special']['position'];
?>
<!-- page content -->
<div id="build_top" class="page-lists">
    ...
    <div class="row">
        ...
        <div class="col-sm-6 col-xs-12" id="buildtop_drop">
            <div class="x_panel">
                <div class="x_title">
                        ...
                        <table class="table table-striped jambo_table table-bordered" id="table_special">
                            <thead id="checkbox_all">
                                <tr class="headings">
                                    ...
                                    <th class="column-title"><?php echo $this->lang->line("course_name"); ?></th>
                                    <th class="column-title" width="150px"><?php echo $this->lang->line("course_cate"); ?></th>
                            ...
                            <tbody id="checkbox_list">
                                ...
                                <tr data-id="<?php echo $row['course_id']; ?>">
                                    ...
                                    <td class="action last" align="center">
                                        <a class="tmp-delete" data-toggle="tooltip" data-placement="top" title="<?php echo $this->lang->line("common_delete"); ?>" data-id="<?php echo $row['course_id']; ?>" href="javascript:void(0)" rel="nofollow">
                ...
                <div class="x_content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-5 col-sm-3 col-xs-12">
                            <button class="btn btn-success buildtop-suggest-button" data-url="<?php echo SITE_URL; ?>/course/suggest_course" type="button"><?php echo $this->lang->line("common_search_text"); ?></button>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                        ...
                        <table class="table table-striped jambo_table table-bordered">
                            ...
                            <tbody id="checkbox_list">
                                ...
                                <tr data-id="<?php echo $row['course_id']; ?>">
                                    ...
                                    <td><?php echo $arrCate[$row['original_cate']]['name']; ?></td>
                                    <td class="action last" align="center">
                                        <a class="tmp-add" data-toggle="tooltip" data-placement="top" title="<?php echo $this->lang->line("common_add"); ?>" data-title="<?php echo $row['title']; ?>" data-cate="<?php  echo $arrCate[$row['original_cate']]['name']; ?>" data-id="<?php echo $row['course_id']; ?>" href="javascript:void(0)" rel="nofollow">
