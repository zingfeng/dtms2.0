    ...
    <tbody id="checkbox_list">
        ...
        <tr data-id="<?php echo $row['course_id']; ?>">
            ...
            <td class="action last" align="center">
                <a class="tmp-add" data-toggle="tooltip" data-placement="top" title="<?php echo $this->lang->line("common_add"); ?>" data-title="<?php echo $row['title']; ?>" data-cate="<?php  echo $row['original_cate']; ?>" data-id="<?php echo $row['course_id']; ?>" href="javascript:void(0)" rel="nofollow">
