						...
						<table class="table table-striped jambo_table table-bordered">
							<thead id="checkbox_all">
								<tr class="headings">
									...
									<?php } ?>
									<th class="column-title"><?php echo $this->lang->line("block_name"); ?></th>
									<th class="column-title" width="150px">Module</th>
									<th class="column-title" width="90px"><?php echo $this->lang->line("block_position"); ?> </th>
									<th class="column-title" width="70px"><?php echo $this->lang->line("block_ordering"); ?> </th>
									<th class="column-title" width="90px"><?php echo $this->lang->line("block_publish"); ?> </th>
							...
							<tbody id="checkbox_list">
								...
								<tr>
									<?php if ($pDelete) { ?>
									<td class="a-center ">
										<input type="checkbox" value="<?php echo $row['block_id']; ?>" class="inputSelect" name="cid[]">
									</td>
									<?php } ?>
									...
									<td class="action last">
										...
										<a data-toggle="tooltip" data-placement="top" title="<?php echo $this->lang->line("common_edit"); ?>" href="<?php echo SITE_URL; ?>/block/edit/<?php echo $row['block_id']; ?>">
										...
										<?php } ?>
										<?php if ($pDelete) { ?>
										<a class="quick-delete" data-toggle="tooltip" data-placement="top" title="<?php echo $this->lang->line("common_delete"); ?>" data-id="<?php echo $row['block_id']; ?>" href="javascript:void(0)" rel="nofollow">
