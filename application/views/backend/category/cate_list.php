...
<div id="cate_lists" class="page-lists">
						...
						<table class="table table-striped jambo_table table-bordered">
							<thead id="checkbox_all">
								<tr class="headings">
									...
									<?php } ?>
									<th class="column-title"><?php echo $this->lang->line("category_cate_name"); ?></th>
									<th class="column-title" width="120px"><?php echo $this->lang->line("category_cate_type"); ?></th>
									<th class="column-title" width="70px"><?php echo $this->lang->line("category_cate_ordering"); ?> </th>
							...
							<tbody id="checkbox_list">
								...
								<tr>
									...
									<td><?php echo $cate_type[$row['type']]['name']; ?></td>
									<td><?php echo $row['ordering']; ?></td>
							
									<td class="action last">
										<?php if ($this->permission->check_permission_backend('edit')) { ?>
										<a data-toggle="tooltip" data-placement="top" title="<?php echo $this->lang->line("common_edit"); ?>" href="<?php echo SITE_URL; ?>/category/edit/<?php echo $row['cate_id']; ?>">
	...
	<div class="page-title scroll_action">
		<div class="title_left">
			...
			<a class="btn btn-primary" href="<?php echo SITE_URL; ?>/category/add"><?php echo $this->lang->line("common_mod_category_add"); ?></a>
			<?php } ?>
			<?php if ($pDelete) { ?>
