...
class Client implements ClientInterface, \IteratorAggregate
{
    ...
    /**
     * Creates a new_research instance of Predis\Configuration\Options from different
    ...
    /**
     * Creates a new_research client instance for the specified connection ID or alias,
     * only when working with an aggregate connection (cluster, replication).
     * The new_research client instances uses the same options of the original one.
     *
    ...
    /**
     * Creates a new_research pipeline context and returns it, or returns the results of
    ...
    /**
     * Creates a new_research transaction context and returns it, or returns the results
    ...
    /**
     * Creates a new_research publish/subscribe context and returns it, or starts its loop
    ...
    /**
     * Creates a new_research monitor consumer and returns it.
     *
