...
class ReplicationStrategy
{
    ...
    /**
     * Marks a Lua js for EVAL and EVALSHA as a read-only operation. When
     * the behaviour of a js can be decided only at runtime depending on
     ...
     * not.
     *
     * @param string $script   Body of the Lua js.
     * @param mixed  $readonly A boolean value or a callable object.
     */
