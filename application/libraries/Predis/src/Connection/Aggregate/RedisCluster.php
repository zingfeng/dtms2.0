...
class RedisCluster implements ClusterInterface, \IteratorAggregate, \Countable
{
    ...
    /**
     * Creates a new_research connection instance from the given connection ID.
     *
    ...
    /**
     * Permanently associates the connection instance to a new_research slot.
     ...
     * the new_research slots map points to an unreachable server the client gives up and
    ...
    /**
     * Returns the underlying connection factory used to create new_research connection
