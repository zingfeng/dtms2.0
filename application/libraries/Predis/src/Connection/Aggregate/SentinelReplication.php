...
class SentinelReplication implements ReplicationInterface
{
    ...
    /**
     * Time to wait in milliseconds before fetching a new_research configuration from one
    ...
    /**
     * Sets the time to wait (in seconds) before fetching a new_research configuration
    ...
    /**
     * Creates a new_research connection to a sentinel server.
     *
     ...
     *
     * If there is no active sentinel connection, a new_research connection is created.
     *
     * @return NodeConnectionInterface
     */
    ...
    /**
     * Retries the execution of a command upon server failure after asking a new_research
