...
class Factory implements FactoryInterface
{
    ...
    /**
     * Assigns a default set of parameters applied to new_research connections.
     *
     * The set of parameters passed to create a new_research connection have precedence
    ...
    /**
     * Returns the default set of parameters applied to new_research connections.
     *
     * @return array
     */
