...
//                    $this->script_handle_bell_1_times(); // zffix
    ...
    public function input_gg_sheets($info)
    {
        ...
        $arr_insert = array('Phone', $info['class_code'], ($teacher['manager_email']) ? $teacher['manager_email'] : '', $teacher['name'], $info['name_feeder'], $location['name'].' - '.$location['area'], date('d/m/Y', time()), $info['times'], (int)$info['point'], $info['comment'], 'https://qlcl.imap.edu.vn/feedback/feedback_phone_detail?class='.$info['class_code']);
